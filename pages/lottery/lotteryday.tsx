...
import { ILotteryDay, LotteryDay } from 'components/templates/lottery/lotteryday';
import { useNetwork } from 'wagmi';
import { Heading, Text, VStack } from '@chakra-ui/react';

const LotteryDayPage: NextPage<ILotteryDay> = (props) => {
