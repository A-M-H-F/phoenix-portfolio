...
const Lottery30: FC<ILottery30> = ({ balance }: any) => {
            ...
            <Table variant="simple" colorScheme="teal" borderWidth={2} borderColor="teal">
              ...
              <Tbody>
                ...
                <Tr>
                  <Td>Service Fees</Td>
                  {ticketCommission ? (
                    <Td color="red.300">{utils.formatEther(String(ticketCommission))} MATIC</Td>
                  ) : (
                    <Td>0</Td>
                  )}
                </Tr>
            ...
            <Table variant="simple" colorScheme="teal" borderWidth={2} borderColor="teal">
              ...
              <Tbody>
                ...
                <Tr>
                  ...
                  <Td color="green.100">
                    {lastWinnerAmount && Number(utils.formatEther(String(lastWinnerAmount)))} MATIC
                  </Td>
                </Tr>
              </Tbody>
              <Tfoot></Tfoot>
